...
public class SquareTest {
    ...
    public void calculateArea() {
        assertEquals(6.25, s2.calculateArea(), 0.0);
        assertEquals(25.0, s1.calculateArea(), 0.0);
    }

    @Test
    public void toString1() {
        assertEquals("Square with side 5.0", s1.toString());
        assertEquals("Square with side 2.5", s2.toString());
    }
